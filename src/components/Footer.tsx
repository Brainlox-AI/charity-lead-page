  ...
  return (
    ...
    <div className='flex flex-col items-center mt-5 py-16'>
            ...
            <div className="relative md:w-[605px]">
                ...
                <button disabled={isDisabled} onClick={sendEmail} className="bg-[#6941C6] font-openSans text-[20px]  h-[59px] w-[193px] absolute right-3 top-3 bottom-3 text-white " style={{borderRadius:"60px"}}>Get Free Demo</button>
              </div>

        </div>

        {/* <!-- Footer --> */}
        <div className="flex justify-between font-normal text-lg px-[100px] py-8 font-roboto">
